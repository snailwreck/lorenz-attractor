...
sigma = st.sidebar.slider("σ (sigma)",  0.0,  20.0, 10.0, step=0.1)
rho   = st.sidebar.slider("ρ (rho)",    0.0,  50.0, 26.0, step=0.1)
beta  = st.sidebar.slider("β (beta)",   0.0,  10.0,  3.0, step=0.01)
...
view = st.radio("Choose the axes to view the Lorenz attractor.", ["X–Z", "X–Y", "Y–Z", "3D"], horizontal=True)
